...
You are given an array of integers arr of size n and a number k. Your task is to determine if the array contains the element k.
...
-1  
Explanation:  
In the input array, element 9 is not present. So, the output is -1.
